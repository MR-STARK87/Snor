...
- Terminal (bottom): real ConPTY `powershell.exe -NoLogo` with colors + block cursor, type commands, quick buttons for `dir` and `opencode --help`. Run `opencode` inside to drive your agent.
